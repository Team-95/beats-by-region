...
class Filters:
    """ Filters is an enum class that stores available filter options and their
    ...
    event_type_titles = {
        "completed": "Completed broadcasts only", 
        "live": "Live broadcasts only", 
        "upcoming": "Upcoming broadcasts only", 
        "all": "All videos"
    }
    
    result_order_options = [
        "date", 
        "rating", 
        "relevance", 
        "title", 
    ...
    duration_titles = {
        "any": "Any length", 
        "long": "Long (Over 20 minutes long)", 
        "medium": "Medium (Between 4 and 20 minutes long)", 
        "short": "Short (Less than 4 minutes long)"
    }
